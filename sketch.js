...
function setup() {
  ...
  noFill();
  hairColor = color(117, 85, 101); // med brown hair color

  // Set the initial position of the face (after canvas is created)
  faceX = width / 10; // Adjust the face on x-axis side to side
  faceY = height / 5; // Adjust the face on y-axis up and down
}

function draw() {
  background(206, 176, 171);  // Clear the old background
  ...
  // Draw the face (basic shape, you can adjust this)
